...
import com.it.hospital_manage.model.OrderInfo;
import com.it.hospital_manage.model.Patient;
...
public class HospitalServiceImpl implements HospitalService {
    ...
    @Transactional(rollbackFor = Exception.class)    // 添加事务，有异常就会回滚，数据库中的数据也会回滚
    @Override
    public Map<String, Object> submitOrder(Map<String, Object> paramMap) {
        ...
        if (!schedule.getHoscode().equals(hoscode)
                || !schedule.getDepcode().equals(amount)
